...
In my `Vendor/Bundle/VendorBundle.php`:
```php
...
and in my `Vendor/Bundle/DependencyInjection/Compiler/OverrideRssAtomBundleProviderCompilerPass.php`:
```php
...
You can follow `services.xml` also but remember that you have to pay attention to bundles registration order.
